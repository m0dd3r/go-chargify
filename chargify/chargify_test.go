...
const (
	subdomain          = "chargify_subdomain"
	apiKey             = "TestApiKey"
	testBaseDefaultURL = "https://chargify_subdomain.chargify.com/"
)
...
var (
	...
	// client is the Chargify client being tested.
	client *Client
...
// setup sets up a test HTTP server along with a chargify.Client that is
...
func setup() {
	...
	// chargify client configured to use test server
...
func TestNewRequest(t *testing.T) {
	...
	inURL, outURL := "/foo", testBaseDefaultURL+"foo"
	inBody, outBody := &Subscription{Id: 3}, `{"id":3}`+"\n"
